How odd these pirate games are. Actually, this is a homebrew port of Mortal Kombat Mythologies: Sub-Zero for Sega Mega Drive. It seems to be developed in the first part of 2000 by 台湾游戏公司 which is completely unknown nowdays. You've never heard of this game? So, now you do =)
It was barely known outside China and no-one seems to talk about it or even mentioning it, so people meet it only by either purchasing a pirate cartridge or watching someone playing it. Personally, I had a cartridge with all MK's ever released on Mega Drive.
...
There 3 types of rooms: with enemies, with traps (stage hazards), with nothing. You fight 1 enemy at the same time. After you kill him, the next one spawns outside the screen. If there are no more enemies to fight, you're able to quit the hallway. 
...
It has a huge map with many rooms and there are enemies in almost all of them. Normally, you should collect 3 keys and visit the major part of rooms, that would take about 12 minutes in total. 1st key opens the door to the 2nd one, 2nd key activates the elevator to the 3rd one, and 3rd key will finally bring to the exit.
I did a major shortcut with help of Sub-Zero's slide tackle move and took the 3rd key quickly, ignoring other 2 keys. The room can be crossed 3 slides , but 2 slides spend all my mana I had to wait until it restores. 2 slides would be enough, but I need 6 more pixels offset to do it with the additional help of a jump. A goblet with the potion restores your mana, like health, but it was not available for me.

! Stage 4

This map is even bigger then Stage 2. There you should collect 3 emeralds and place them in certain places. 
The whole map can be seen  [https://lh3.googleusercontent.com/AcYDtRsxOsqyfx3VaiHJNrVtAniMwq04Dr9Dp1R6aP0JT3NBN_9dWXvjgO3cx5OumYwm8uoQzg1POZmYoQA2RtqhbstQS9C6XAcRBw9SSreoY8nbeyAZgVSC_rO5RnjnvDmu2iz-RPOb-JnDFT2HFgS-fwkSVHU7jEJoLvYGk5DWXV5ZuKvlqcUJ5RxhOCIDa8igvQ_h6aGk_kRfhanJH6l_ZGF4MhM31iK-k6yjt_HP9n_QqhqziQJco7KYVF4U5i33njIY7Kcfd_576ZfC8BPdb4x3phhoJlzTgxOWUOBnkNlnXkVyHDU-A3tqOSZH45auw-1DuHDVDDBKmMISAY_o5tl_BXs0v3Vk2SJdiEQG3QKC2z-9bqBd-sEEVifQLmj8lVCrm-0okc8m5d2tqZOTJHCB2NWgBH-bQOLV_6bA1L_nmgEUCqHCckpgDZTFawfqWzIkU1xJw4hgUaIXs3ZuOzcl8Jakn_ORueyf5vl8GxtW29xTxkmDpued14vmKfdErtkF9QDW8EgXQCzVICwT9NfYziGwYoZdc0qXWFdftKR-UgAuIPXTZU5sDH3ZOUtzZqEabj0-NH1eghOI1KDyNh8xfuNLXwkopMAHe8G7d8GRjbeWI3xUMteEds0WXSdehxTlKSQVATFEKPZLVd-p=w1235-h466-no|here]. Hallways proportions are wrong, because I drew it for myself.
Nothing to add. This stage is boring even on Easy difficulty.

Fortunately, this stage can be completed with the help a weird glitch, which I call "floor glide glitch". It finishes the stage if Sub-Zero falls through the ground. See its description below. A similar trick was used to complete [Streets of Rage 1|https://www.youtube.com/watch?v=WT6vbOu15CA].
...
__Note__: This glitch WASN'T used in this TAS!
It's a weird glitch that finishes the stage if Sub-Zero falls through the ground. Normally, if Sub-Zero falls below the screen, he dies, but there is no pits on this stage, so this function isn't invoked there. The actual reason of such an odd game's behaviour is unknown for me. 
To reproduce it, you have to use Sub-Zero's ground freeze attack on an enemy and then jump towards his/her body. If you catch the right moment, Sub-Zero will move down through the floor.
...
Press down and right (if you're faced to the right). Then hold Right at least for 1 frame. While holding Right, press B. 
It has to be like that: \/>, >, >B.

! Ice puddle

The same as above.
It has to be like that: <\/, <, <C.

Well, it's all over not. Useful RAM Watch addresses can be downloaded [=userfiles/info/51156238337520959|here] in case someone will ever visit this game.
