> **Imported**
> This run was originally published at https://tasvideos.org/3838M and entered this archive as a voluntary
...
https://www.youtube.com/playlist?list=PL3V0eG1j-1vLSfQzFOolAAbrvx-eJEcsj
...
! Casey Jones
Though I have put a faster walkthrough of Turtles’ Lair stage, there is an alternative execution where I kill Splinter with the help of TVs. I found it more entertaining, but I had walked so far away from this point and it was too late. https://www.youtube.com/watch?v=HgfBYoWyivg&index=12&list=PL3V0eG1j-1vLSfQzFOolAAbrvx-eJEcsj&t=8s
! Foot Ninja
...
Killing April at her Apartment stage was also slow. The game just gives me a fail screen for no reason if I complete the stage too fast. However, my first stage test (in 25 secs) was also considered as a fail. I don’t know how the game finds the fail, but it seems to be a program error. The fastest run is here: https://www.youtube.com/watch?v=HgfBYoWyivg&index=12&list=PL3V0eG1j-1vLSfQzFOolAAbrvx-eJEcsj&t=63s
! Hun
...
Junkyard section can be done faster, but you will pass the stage. https://www.youtube.com/watch?v=HgfBYoWyivg&index=12&list=PL3V0eG1j-1vLSfQzFOolAAbrvx-eJEcsj&t=136s
! Splinter
