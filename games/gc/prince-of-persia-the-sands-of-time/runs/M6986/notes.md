...
!!! Thank You Note
I want to specially thank toca for helping me with ideas and suggestions, as well as trying out some skips during the making of the TAS. I want to thank him, epicdudeguy and Jaka for organizing and doing commentary with me. Thanks to solarplex for the [https://forum.toolassisted.run/t/any-zipless-partial-tas-by-solarplex/1181|partially completed TAS] where I borrowed some tricks from, and likewise to the [https://www.youtube.com/watch?v=AX3kW5yhISs|Segmented run] which was the main reference I used for making this run. I'm grateful to the PoP community for the strategies and support.
