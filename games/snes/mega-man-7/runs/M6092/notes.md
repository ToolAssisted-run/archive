...
> This run was originally published at https://tasvideos.org/6092M and entered this archive as a voluntary
...
!! Summary
*This is an improvement over the current [1537M|published run] by 4402 frames (or 73.37 seconds). However, due to this run using US version instead of Japanese version and also done on a more accurate emulator that creates more lag and longer loading times, this run appears to be only 31 seconds ahead.
...
*Now, all that is good, but Rush Search has different delays before it finishes digging up an item, and those delays are very random. [user:FractalFusion] explained perfectly how it works in this [Forum/Posts/482332|post]. Due to that, sometimes it is not worth using for minimal time save like moving during Bass cutscene in Shade Man's stage for instance (only place tbh).
...
!! Special thanks
*__[user:FractalFusion]:__ Immensely for his WIP TAS... It truly packaged all strats used in this run and was very helpful. I optimized as much as I could but was a great guide
*__[user:PJ]:__ For finding the early Proto Man fight. It is an awesome and cool trick, and save a good amount. He also explained well how it goes.
*__[user:sparky]:__ His 100% is one of my favorites on the site. I tried to be entertaining in this run during stand still moments, but he far ahead on me in this regard. I do recommend watching both of his [1550M|Any%] and [1537M|100%] runs, even if this TAS gets published.
...
[#3]: These time losses were due to route change, as we don't have Wild Coil for fast Shade Man fight AND we do a revisit that should cost some seconds at first but we gain a lot later on. Around 413 frames from my calculations, which can be found in this [Forum/Posts/530690|post].
